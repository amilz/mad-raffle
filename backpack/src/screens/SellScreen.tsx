...
export function SellScreen() {
  ...
  }, [loading, madRaffle, selectedNft, player, connection, onComplete
  ]);
      ...
      {selectedNft ?
        ...
        >
          <Text style={tw`text-black font-bold text-lg`}>
            {loading ? "Selling Lad..." : `Sell a Lad for ${solPriceString} SOL`}
          </Text>
        </Button> : <></>
      }
